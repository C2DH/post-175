      ...
      <div className="h-100vh d-flex flex-column bg-dark">
        ...
        <div className='row no-gutters flex-1 w-100 d-flex p-3 bg-black'>
          ...
          <div className="d-flex h-100 flex-1 flex-column">
            <p style={{fontSize: 24, fontWeight: 300}}>Cras ultricies ligula sed magna dictum porta. Sed porttitor lectus nibh.
            ...
            <div className="d-flex flex-column">
              <div className="p-3 border mb-1">
                <Link to={url('/timeline')}>
                  <span style={{fontSize: 24, fontWeight: 300}} className="text-light d-flex d-inline-flex justify-content-between align-items-center w-100">
        ...
        <div className='row no-gutters w-100 fixed-bottom d-flex align-items-center bg-opaque-black' style={{height: 60}}>
          <p className="m-0 pl-3">A project by the Luxembourg Centre for the Contemporary and Digital History (CD2H)</p>
        </div>
      </div>
    )
  }
