export default {
  de: {
    ...
    menu_themes: "Thematischen dossiers",
    ...
    uncertain_dates: "Objekte ohne gesichertes Datum einbeziehen",
    uncertain: "gesichertes Datum",
    other: "andere",
    book: "buch",
    map: "karte",
    advertising: "werbung",
  ...
  fr: {
    ...
    uncertain_dates: "inclure objets avec datation incertaine",
