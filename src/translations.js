export default {
  de: {
    ...
    home_readmore: 'Mehr',
    home_footer: 'Ein Projekt des Luxembourg Centre for Contemporary and Digital History',
    // map page
  ...
  fr: {
    ...
    home_footer: 'Un projet du Luxembourg Centre for Contemporary and Digital History',
    // map page
