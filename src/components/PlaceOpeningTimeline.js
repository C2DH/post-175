    ...
    return (
      <div>
        <svg width={width} height={HEIGHT}>
          ...
          {/* Bottom text extent */}
          <text x={5} y={TIMELINE_Y + 20} className="opening-timeline-text">
          ...
          >
            ...
            <tspan x={scale(openDate) - 15} dy={12}>
          ...
          {!isOpen && (
            <text
              ...
              className="opening-timeline-text"
            >
              <tspan x={scale(closeDate) - 20}>
                {t("map_mapTooltipClose")}
              </tspan>
              <tspan x={scale(closeDate) - 10} dy={12}>
