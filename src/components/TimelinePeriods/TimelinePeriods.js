    ...
    return (
      <Fragment>
        <div
          ...
          className="bg-white p-3 d-flex flex-column align-items-center pop-up"
          style={{
            position: "absolute",
        ...
        >
          <h3>
            ...
            {"-"}
            {period.endDate.getFullYear() + 1}
          </h3>
          <p className="">{period.data.description}</p>
        </div>
        <div
          style={{
            position: "absolute",
  ...
  render() {
    ...
    return (
      <div
        ...
        className="d-flex bg-white TimelinePeriods"
      >
        {showPopupPeriod && (
          <PopUpPeriod
            scale={scale}
